...
public class Utils {
    ...
    private static final boolean initPlaceholders;

    static {
        initPlaceholders = Bukkit.getPluginManager().isPluginEnabled("PlaceholderAPI");
    }

    public static String applyPlaceholders(String str, Player holder){
        return initPlaceholders ? PlaceholderAPI.setPlaceholders(holder, str) : str;
    }
